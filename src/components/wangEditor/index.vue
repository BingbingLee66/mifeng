...
<template>
  <div>
    ...
    <el-button @click="getText"></el-button>
  </div>
</template>
<script>
...
export default {
  ...
  mounted() {
    ...
    editor.config.uploadImgServer = 'https://ysh-test.kaidicloud.com/ecservice/upload/richhtml-custom-img-upload'
