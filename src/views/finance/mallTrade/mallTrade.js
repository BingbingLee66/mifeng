import { getChamberFinanceData, getChamberFinanceShopThisMonth, getChamberFinanceShopDay } from '@/api/finance/finance'
...
export default {
  ...
  methods: {
    ...
    getStatistics () {
      ...
      getChamberFinanceShopThisMonth(params).then(response => {
    ...
    fetchData() {
      ...
      getChamberFinanceShopDay(params).then(response => {
