  ...
  <div class="app-container">
    <div class="block">
      <div class="stat-card">
        ...
        <div class="card-box">
          <div class="card-box-3">
            <el-button type="danger" :actionid="getId('', '前往结算提现')" v-if="has('', '前往结算提现')" @click="goSettle">前往结算提现
            </el-button>
          </div>
        </div>
      </div>
    ...
    <el-tabs>
      <el-tab-pane label="会员缴费数据">
        <div class="block">
          ...
          <el-button type="primary" size="mini" :actionid="getId('', '导表')" v-if="has('', '导表')" style="float: right;" @click="exportExcel1($event)">
            导表
          </el-button>
        </div>
      ...
      <el-tab-pane label="会员缴费详情">
        <div class="block">
          ...
          <el-button type="primary" size="mini" :actionid="getId('', '导表')" v-if="has('', '导表')" style="float: right;" @click="exportExcel2($event)">
            导表
          </el-button>
        </div>
