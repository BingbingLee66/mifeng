  ...
  <div class="app-container">
    ...
    <div style="margin: 20px 0">
      <el-form ref="query" label-position="right" :inline="true" size="mini" :model="query">
        ...
        <el-form-item v-if="type !== '0'" label="活动状态">
    ...
    <el-dialog title="预览" :visible.sync="previewImgVisible" width="50%">
      <img
        v-if="previewUrl.indexOf('.jpeg') != -1 || previewUrl.indexOf('.jpg') != -1 || previewUrl.indexOf('.png') != -1"
        :src="previewUrl"
        style="width: 100%; padding: 20px"
      >
      <video v-else :src="previewUrl" style="width: 100%; padding: 20px" controls>您的浏览器不支持 video 标签。</video>
    </el-dialog>
  </div>
</template>
