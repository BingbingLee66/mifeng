<template>
  <div class="app-container">
    <div class="top-block">
      ...
      <div class="red-label goods">【100036】10元福利券 </div>
      <div class="blue-label">查看详情</div>
    </div>
    <div class="from-block">
      <el-form ref="query" label-position="right" :inline="true" size="mini" :model="query">
        ...
        <el-form-item label="用户属性">
          <el-select v-model="query.property" placeholder="请选择">
      ...
      <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
        ...
        <el-table-column label="接收方/领取方-用户名">
          <template slot-scope="scope">
            <div class="blue-label" @click="goMemberDetail">{{ scope.row.name }}</div>
          </template>
        </el-table-column>
