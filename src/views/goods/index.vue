  ...
  <div class="app-container">
    ...
    <div v-if="activeName == '8'">
      ...
      <div class="block">
        <el-row>
          <el-col :span="24">
            <el-button type="primary" size="small" :actionid="getId('商品列表', '上架')" v-if="has('商品列表', '上架')" @click.native="batchUpdateStatus($event, 1)">上架</el-button>
            <el-button type="primary" size="small" :actionid="getId('商品列表', '下架')" v-if="has('商品列表', '下架')" @click.native="batchUpdateStatus($event, 2)">下架</el-button>
            <el-button type="primary" size="small" :actionid="getId('商品列表', '删除')" v-if="has('商品列表', '删除')" @click.native="batchDel($event)">删除</el-button>
            <el-button type="danger" size="small" :actionid="getId('商品列表', '发布新商品')" v-if="has('商品列表', '发布新商品')" @click.native="addGoods($event)">发布新商品</el-button>
          </el-col>
        </el-row>
      </div>
