<template>
  <div class="app-container">
    ...
    <div style="margin-bottom:30px">
      <el-button v-if="has('', '通过') && query.auditStatus == 0" type="success" size="small" :actionid="getId('', '通过')" @click="batchApproved($event)">
        通过
      </el-button>
      <el-button v-if="has('', '驳回') && query.auditStatus == 0" type="warning" size="small" :actionid="getId('', '驳回')" @click="batchRejectRemark($event)">
        驳回
      </el-button>
    </div>
