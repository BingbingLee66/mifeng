  ...
  <div>
    <el-dialog title="" :visible.sync="detailVisible" width="70%">
      <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit>
        <template>
          <el-table-column v-for="(item,index) in tableData" :key="index" align="center" :label="item.name" :prop="item.vale" />
        </template>
      </el-table>
      <el-pagination
        background
...
export default {
  ...
  data() {
    return {
      ...
      // 自定义埋点数据数组
      moduleList9: [
        { name: '总点击数', vale: 'total', }, { name: '热门供需_导航点击', vale: 'hotDemandMenuSum', },
        { name: '热门供需_添加供需数量', vale: 'hotDemandAddSum', }, { name: '轮播图更新_导航点击', vale: 'carouselMenuSum', },
        { name: '轮播图更新_添加轮播图数量', vale: 'carouselAddSum', },
      ],
      moduleList10: [
        { name: '总点击数', vale: 'total', }, { name: '发布图文供需_导航点击', vale: 'imageDemandMenuSum', },
      ...
      moduleList11: [
        { name: '总点击数', vale: 'total', }, { name: '商/协会会员_导航点击', vale: 'chamberMemberMenuSum', }, { name: '商/协会会员_添加会员数量', vale: 'chamberMemberAddSum', }, { name: '商/协会会员_发送短信数量', vale: 'chamberMemberMsgSendSum', },
      ...
      moduleList12: [
        { name: '总点击数', vale: 'total', }, { name: '会内职务_导航点击', vale: 'chamberPostMenuSum', },
      ...
      moduleList13: [
        { name: '总点击数', vale: 'total', }, { name: '栏目设置_导航点击', vale: 'columnSetMenuSum', },
        { name: '栏目设置_添加栏目', vale: 'columnSetAddSum', }, { name: '文章更新_导航点击', vale: 'articleUpdateMenuSum', },
        { name: ' 文章更新_创建文章', vale: 'articleUpdateAddSum', },
      ],
      moduleList14: [
        { name: '总点击数', vale: 'total', }, { name: '创建活动_导航点击', vale: 'activityCreatedMenuSum', },
      ...
      moduleList15: [
        { name: '总点击数', vale: 'total', }, { name: '会员数据_导航点击', vale: 'userDataMenuSum', },
        { name: '会员画像_导航点击', vale: 'userPersonaMenuSum', }, { name: '供需数据统计_导航点击', vale: 'demandDataStatsMenuSum', },
      ],
      moduleList16: [
        { name: '总点击数', vale: 'total', }, { name: '入会专属二维码_导航点击', vale: 'unionizeQrCodeMenuSum', },
  ...
  methods: {
    ...
    choose(moduleId) {
      const stats = { name: '商协会名称', vale: 'chamberName' }
      const detail = { name: '日期', vale: 'date' }
