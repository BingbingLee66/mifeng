<template>
  <div class="app-container">
    ...
    <el-tabs>
      <el-tab-pane label="商会商城数据"></el-tab-pane>
    </el-tabs>
    <div class="block">
    ...
    <div class="block">
      ...
      <el-button type="primary" size="mini" style="float: right;" @click="exportExcel3($event)">导表</el-button>
    </div>
    <el-table :data="list3" v-loading="listLoading3" element-loading-text="Loading" border fit highlight-current-row @selection-change="handleSelectionChange3">
      <el-table-column type="selection" width="55px">
      </el-table-column>
      <!-- <el-table-column type="index" label="序号" width="60px">
      </el-table-column> --> 
