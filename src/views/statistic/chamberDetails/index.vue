<template>
  <div class="app-container">
     <tabulation :type="2" ref="tabulation"></tabulation>
    <div class="chamber-statistics">
        <h3>{{DetailsName}} - 数据详情</h3>
        <div class="text-btn-style" @click="showMeaning=true">数据定义</div>
    </div>
    <div class="chamber-statistics">
        <div>
            <el-select style="width:320px;margin-right:20px" v-model="query.ckey" placeholder="数据维度" filterable @change="change">
                <el-option v-for="item in chamberList" :key="item.id" :label="item.name" :value="item.ckey"></el-option>
            </el-select>
             <el-radio-group style="margin-right:20px" v-model="days"  @change="initDatePicker">
            ...
            <el-radio-group v-model="query.type"  @change="typeDatePicker">
