  ...
  <div class="menber_manager_container">
    <div class="menu_tree">
      ...
      <div class="department-list" v-show="!showFlag">
        <el-tree :data="departmentTree" node-key="id" :props="{ value:'id',children:'departmentRespList' }" :expand-on-click-node="true" :highlight-current="true" :current-node-key="-1" :default-expanded-keys="[-1]" :default-checked-keys="[-1]" @node-click="handleNodeClick">
    ...
    <div class="content_wrap">
      ...
      <div class="content_item table_wrap">
        <el-table style="width: 100%" :header-cell-style="{background:'rgba(245,245,245,0.5)',color:'#000',fontSize:'15px'}" ref="multipleTable" :data="memberData" tooltip-effect="dark" @row-click="skipToDetail" @selection-change="handleSelectionChange">
          ...
          <el-table-column width="200" prop="companyPhone" label="联系电话" show-overflow-tooltip>
            <template slot-scope="scope">
      ...
      <el-dialog :visible.sync="showDialog" title="调整部门" width="500px">
        <div class="from_wrap">
          <div class="from_item">
            ...
            <el-cascader clearable :show-all-levels="false" :options="departmentOptions" :props="{
                emitPath:false,
                checkStrictly: true ,
                value:'id',
                label:'departmentName',
                children:'departmentRespList'
              }" v-model="departmentCas" placeholder="请选择部门" @change="handlerDepartmentChange">
            </el-cascader>
          </div>
