<template>
  <div class="app-container">
    ...
    <div v-if="activeName == '1'">
      ...
      <el-row>
        <el-button type="primary" size="small" @click="openPublishBatch($event)" :actionid="getId('采集结果', '发布')" v-if="has('采集结果', '发布')">发布</el-button>
      ...
      <el-table id="out-table" :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row @selection-change="handleSelectionChange">
        ...
        <el-table-column label="采集文章发布时间" width="160px">
          <template slot-scope="scope">
            {{scope.row.publishTs}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="采集网站" width="200px">
          <template slot-scope="scope">
            {{scope.row.websiteName}}
          </template>
        </el-table-column>
        <el-table-column label="采集频道" width="130px">
          <template slot-scope="scope">
            {{scope.row.channel}}
          </template>
        </el-table-column>
    ...
    <div v-if="activeName == '2'">
      ...
      <el-table id="out-table" :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row @selection-change="handleSelectionChange">
        ...
        <el-table-column label="回收时间" width="160px">
          <template slot-scope="scope">
