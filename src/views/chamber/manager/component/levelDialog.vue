<template>
  <div>
    <el-dialog title="详情" :visible.sync="detailVisible" @close="close" :width="width">
      ...
      <el-form label-width="60px" :model="form" ref="formName" :rules="rules">
        <el-form-item
          label="权重"
          prop="level"
        >
          <el-input v-model.number="form.level" maxlength="3" min="1"></el-input>
        </el-form-item>
        <div class="msg-view">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="updateChamberLevelFunc"
          >提交</el-button
        >
      </span>
    </el-dialog>
...
export default {
  props: ["title", "width"],
  data() {
     var levelChack = (rule, value, callback) => {
        if (value<0) {
