    ...
    <main v-loading="loading">
      <el-form ref="form" :model="form" label-width="180px">
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="入驻状态：" prop="auditStatus">
        ...
        <el-row :gutter="10">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="信用状态：" prop="codestatus">
                <el-select
                  v-if="isEdit"
                ...
                >
                  <el-option
                    v-for="code in codestatusOptions"
                    :key="code.value"
                    :label="code.label"
                    :value="code.value"
                  />
            ...
            <el-col :span="12">
              <el-form-item label="成立时间：" prop="establishTime">
                ...
                />
                <span v-show="!isEdit">{{
                  form.establishTime | dateFormat2
                }}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="录入方式：" prop="dataSource">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="业务范围：" prop="params">
                <el-input
                  ...
                  placeholder="请输入业务范围"
                />
                <span v-show="!isEdit && !isInOrganEdit">{{
                  form.params
                }}</span>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="主要人员">
                <div v-if="form.chamberPersons.length == 0">暂无主要人员</div>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row v-for="(item, index) in form.chamberPersons" :key="index">
            <el-col :span="12">
              <el-form-item label="姓名" prop="president">
                <!-- <el-input
                  v-show="isEdit || isInOrganEdit"
                  v-model="form.chamberPersons[index].name"
                  placeholder="主要人员"
                /> -->
            ...
            <el-col :span="12">
              <el-form-item label="职务" prop="president">
                <!--  <el-input
                  v-show="isEdit || isInOrganEdit"
                  v-model="form.chamberPersons[index].position"
                  placeholder="请输入职位名称"
                /> -->
                <span>{{
                  form.chamberPersons[index].position
                }}</span>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-col :span="12">
            <el-form-item label="法定代表人：" prop="address">
              <el-input
                v-show="isEdit"
          ...
          <el-col :span="12">
            <el-form-item label="会长姓名" prop="address">
          ...
          <el-col :span="12">
            <el-form-item label="入驻时间：" prop="auditedTs">
          ...
          <el-col :span="12">
            <el-form-item label="社会组织logo：" prop="systemLogo" class="">
              <el-image
                v-show="form.systemLogo"
                :src="form.systemLogo"
                class="system_logo"
                :preview-src-list="[form.systemLogo]"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      this.loading = true
      // const {data} = await
      OrganizationDetail(this.form.id)
        .then(res => {
          console.log(res, 'res')
          const { state, data, msg } = res
          if (state === 1) {
            this.form = data
            this.$set(this.form, 'params', JSON.parse(data.params).business)
            // this.form.params = JSON.parse(data.params).business;
            console.log(this.form, 'this.form')
            const { auditedTs, establishTime } = this.form
            this.form.auditedTs =
              auditedTs === null ? null : parseInt(auditedTs)
            this.form.establishTime =
              establishTime === null ? null : parseInt(establishTime)
          } else {
    ...
    submit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          let obj = { business: data.params }
          data.params = JSON.stringify(obj)
          console.log(data.params)
          this.loading = true
          console.log(data)
          // let wuhu = JSON.stringify(data)
