  ...
  <div class="app-container">
      ...
      >
        <el-row style="margin: 0">
          ...
          <el-col :span="4" style="margin-left: 10px; margin-right: 10px">
            <el-form-item label-width="110px" label="收货人手机号">
              <el-input
                v-model.trim="query.consigneeMobile"
          ...
          <el-col :span="4" style="margin-right: 10px">
            <el-form-item
              label="生成结算单"
              v-if="query.status == 5 || query.status == 6"
            >
          ...
          <el-col :span="4" style="margin-right: 10px">
            <el-form-item
              label="商品结算状态"
              v-if="
                query.settled == 1 && (query.status == 5 || query.status == 6)
              "
            >
        ...
        <el-row style="margin-bottom:0px">
          <el-col :span="8">
           ...
           <el-col :span="4">
            <el-form-item label-width="110px" label="大礼包ID">
              <el-input
           ...
           <el-col :span="4">
            <el-form-item label-width="110px" label="大礼包名称">
              <el-input
                v-model.trim="query.giftName"
                placeholder="请输入"
              />
            </el-form-item>
          </el-col>
           <el-col :span="4">
            <el-form-item label-width="110px" label="优惠券ID">
              <el-input
        ...
        <el-row>
           <el-col :span="4">
            <el-form-item label-width="110px" label="优惠券名称">
              <el-input
                v-model.trim="query.couponName"
                placeholder="请输入"
              />
            </el-form-item>
          </el-col>
    ...
    >
      ...
      <el-table-column label="用户属性" width="100">
       ...
       <el-table-column label="大礼包" width="100">
        <template slot-scope="scope">
          <div > <el-link type="primary" @click="goSpreeDetail(scope.row.giftId)">{{scope.row.giftId}}</el-link></div>
          <div>{{scope.row.giftName}}</div>
        </template>
      </el-table-column>
         <el-table-column label="优惠券" width="100">
        <template slot-scope="scope">
           <div > <el-link type="primary"  @click="goCouponDetail(scope.row.templateId)">{{scope.row.templateId}}</el-link></div>
