...
export function getCompanyAuditList(params) {
  return request({
    url: '/api/ecservice/ec/companyAudit/companyAudit-list',
    method: 'get',
    params
  })
}
...
export function getArticleCommentList(params) {
  return request({
    url: '/api/ecservice/ec/articleComment/getArticleCommentList',
    method: 'post',
    params
  })
}
...
export function updateCommentStatus(params) {
  return request({
    url: '/api/ecservice/ec/articleComment/updateStatus',
    method: 'put',
    params
  })
}
...
export function getCompanyDetail(params) {
  return request({
    url: '/api/ecservice/ec/companyAudit/companyAudit-one',
    method: 'get',
    params
  })
}
...
export function updateCompanyAudit(params) {
  return request({
    url: '/api/ecservice/ec/companyAudit/audit-status',
    method: 'put',
    data: params
  })
}
...
// 获取文章正文中上传的图片列表
export function textImages(params) {
  return request({
    url: `/ecservice/ec/article/textImages`,
    method: 'get',
    params
  })
}
// 文章公众号封面修改
export function updateWeChatCover(data) {
  return request({
    url: `/ecservice/ec/article/wechatCover`,
    method: 'put',
    data
  })
}
