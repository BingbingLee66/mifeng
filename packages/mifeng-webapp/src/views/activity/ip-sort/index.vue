<template>
  ...
  >
    <template #toolBar>
      <a-button class="mr-5" @click="onDownLoadSignin">导出模版</a-button>
  ...
  <AModal v-model:visible="importVisible" title="导表" :footer="null">
    ...
    <div class="mt-6 flex justify-around">
      <a-button @click="onDownLoadSignin"> 下载导入表 </a-button>
...
<script setup>
import { getIpCardList, getCardExcel, uploadSignin } from '@/api/activity/activity-verify-new'
