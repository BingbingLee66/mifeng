  ...
  <Panel>
    ...
    >
      <div class="article-box-left">
        ...
        <AFormItem v-if="hasEntry" label="相关人物：">
          <RelatedRecommend
            ...
            <div v-else>
              ...
              <AFormItem>
                <ARadioGroup v-model:value="formObj.publishSet">
                  <ARadio :value="1">立即发布到公众号</ARadio>
                  <ARadio :value="2">
                    我还要写多篇文章，暂不发布到公众号
                    <ATooltip>
                      <template #title>
                ...
                <div class="article_news">
                  <div v-for="(item, index) in formObj.wechatArticles" :key="index" class="article_news-boxes">
                    <div class="news-boxes-left">
                      ...
                      <div v-if="index == 0" class="news-boxes-frist">
                        ...
                        <div class="frist-essay-button">
                          ...
                          <AButton type="primary" plain @click="onNewest(5)">最新五篇</AButton>
                    ...
                    <div class="news-boxes-right">
                      ...
                      <!-- 下移 -->
                      <arrow-down-outlined v-if="formObj.wechatArticles.length - 1 !== index" @click="down(index)" />
                    </div>
                  </div>
                </div>
              </AFormItem>
