...
export function getGuestList(params) {
  return request({
    url: "/ecservice/ec/activity-guests/page",
    method: "get",
    params,
  });
}
...
export function getChamberGuestList(params) {
  return request({
    url: "/ecservice/ec/chamber-guests/page",
    method: "get",
    params,
  });
}
...
export function delChamberGuest(id) {
  return request({
    url: `/ecservice/ec/chamber-guests/delete?id=${id}`,
    method: "delete",
  });
}
...
export function updateChamberGuest(params) {
  return request({
    url: "/ecservice/ec/chamber-guests/update",
    method: "put",
    data: params,
  });
}
...
export function checkGuess(data) {
  return request({
    url: "/ecservice/ec/activity-guests/check",
    method: "post",
    data,
  });
}
