<template>
  <div
    v-if="detailVisible"
    class="preview-container flex-x-center-center"
    @click.stop="hide"
  >
    <div class="right">
      <!-- 头部图片 -->
      ...
      <div class="container-wrapper">
        <div class="right-content">
          <div class="right-top">
            <img
              v-if="formState.headImage.length"
              :src="formState.headImage[0].url"
              class="pic"
              alt=""
            />
          </div>
          <div class="content">
            ...
            <div class="active-middle">
              ...
              <div class="active-data">
                <div class="active-left">
                  <img
                    class="active-avatar"
                    :src="systemLogo ? systemLogo : imgUrl"
                    alt=""
                  />
                </div>
                <div class="active-right">
                  <div class="right-cham">
                    {{ chamberName ? chamberName : "凯迪云商会总后台管理系统" }}
                  </div>
                  <div class="right-member">已入驻200名会员</div>
                </div>
              </div>
              <img
                src="https://ysh-cdn.kaidicloud.com/prod/png/active.png"
                class="pic"
                alt=""
              />
              <div class="coverLabel">
                ...
                <div v-if="formState.authAlbum === 1" class="defaultLabel">
                  会员图片
                </div>
            ...
            <div
              id="my-phone-article-content"
              class="phone-article-content"
              v-html="formState.introduce"
            />
          </div>
        </div>
      </div>
