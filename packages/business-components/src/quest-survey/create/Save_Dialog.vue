...
import { downloadByBlob } from '@business/common/src/utils/index'
import { updateState } from '@business/common/src/quest-survey/api'
import { getQrCode } from '@/api/quest-survey/index'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const getQrCodeFunc = async questionId => {
      ...
      } = await getQrCode({ questionnaireId: questionId })
