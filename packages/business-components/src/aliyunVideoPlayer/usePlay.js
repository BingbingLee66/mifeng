import { getSts } from '@business/common/src/utils/vod'
import { decrypt } from '@business/common/src/utils/cryptoUtils'
...
export const renderVideo = async (vid, autoplay, vHeight, cover, targetId) => {
  ...
  if (!window.Aliplayer) {
    await loadScript(
      'https://ysh-cdn.kaidicloud.com/prod/bee/lib/js/aliplayer-min.js'
    )
    await loadScript(
      'https://ysh-cdn.kaidicloud.com/prod/bee/lib/js/aliplayercomponents-1.0.5.min.js'
    )
  }
