  ...
  >
    <div class="sider-bar-wrap">
      <div class="logo" @click.stop="$emit('clickLogo')">
        <img v-if="collapsed" class="collapsed-logo" src="@/assets/imgs/commons/logo.png" />
        <div v-else class="uncollapse-logo">
          <img src="@/assets/imgs/commons/logo2.png" />
        </div>
      </div>
...
.sider-bar {
  ...
  .logo {
    ...
    .uncollapse-logo {
      width: 100%;
      height: 172px;
      background: url('@/assets/imgs/siderbar/bg.png') no-repeat;
