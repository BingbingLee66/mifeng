...
import { COMPONENT_KEY, BUSINESS_TYPE, SHARE_TIPS } from '@business/common/src/quest-survey/create/index'
import dayjs from 'dayjs'
import { getBaseQuestion, questionDetail, getCommonList, uploadAndCheckImg, saveQuest } from '@/api/quest-survey/index'
import { computed, ref, inject, getCurrentInstance } from 'vue'
import Component_Single_Select from '@business/components/src/quest-survey/create/Component_Single_Select.vue'
import Component_Pulldown_Select from '@business/components/src/quest-survey/create/Component_Pulldown_Select.vue'
import Component_Single_Text from '@business/components/src/quest-survey/create/Component_Single_Text.vue'
import Component_Upload from '@business/components/src/quest-survey/create/Component_Upload.vue'
import Save_Dialog from '@business/components/src/quest-survey/create/Save_Dialog.vue'
export default {
  components: {
    draggable,
    Component_Single_Select,
  ...
  setup() {
    ...
    const questionDetailFunc = async () => {
      ...
      const res = await questionDetail(params)
      if (res.state === 1) {
        formatData(res)
      } else {
