...
<script setup>
import { answersUserDetail } from '@/api/quest-survey/answer'
import { COMPONENT_KEY, COMPONENT_KEY_MAP, FILE_TYPE_MAP } from '@business/common/src/quest-survey/create/index'
import { ref, watchEffect } from 'vue'
import { useRoute } from 'vue-router'
import AliyunVideoPlayer from '@business/components/src/aliyunVideoPlayer/index.vue'
...
watchEffect(
  async () => {
    const { data } = await answersUserDetail({ businessType: 1, questionnaireId, userId: _userId.value })
